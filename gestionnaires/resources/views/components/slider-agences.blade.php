        ...
        <div class="card-agence">
          ...
          <div class="content">
            ...
            <div class="other-data">
              <div class="product-name">Type: <span>Prestataire</span></div>
              <div class="product-name">Service: <span>Mariage</span></div>
              <div class="product-name">Ville: <span>Agadir</span></div>
              <div class="product-name">Prix A partir de : <span> 200 DH</span></div>
            </div>
            <div class="rating">
          ...
          <div class="button-container">
            <button class="buy-button button">Lire Plus</button>
          </div>
        </div>
        <div class="card-agence">
          <div class="image-container">
